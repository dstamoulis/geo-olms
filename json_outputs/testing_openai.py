...
def query_chatgpt_for_autogen_workflow(user_query: str, input_file: dict = None):
    ...
    system_prompt = (
        ...
        "Each agent should have config details that specify its unique name string, a model_client, list of tools, list of handoffs, and its description. "
        "The model client should provide details to specify which LLM model needs to be used."
        "The tools should be a list of strings that specify the tools the agent can use. "
        "The possible map tools are: 'plot_images_scatter_map', 'plot_detections_catergory_scatter_map', 'plot_land_cover_class_scatter_map', 'reset_map', 'zoom_map'"
        "The possible data tools are: 'query_dataset_images', 'query_images_by_aoi_coords', 'count_filtered_images', 'count_detections_by_category', 'count_lcc_classification_results_by_category'"
        "The possible vision tools are: 'run_detector', 'run_land_coverage_classifier'"
